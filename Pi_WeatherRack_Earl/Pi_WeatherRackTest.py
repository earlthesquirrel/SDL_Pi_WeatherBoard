#!/usr/bin/env python
#
# Pi_WeatherRack Example Test File 
...
weatherStation = Pi_WeatherRack.Pi_WeatherRack(anenometerPin, rainPin, 0,0, MODE_I2C_ADS1015)

weatherStation.setWindMode(MODE_SAMPLE, 5.0)
#weatherStation.setWindMode(MODE_DELAY, 5.0)
